...
extension Color {
    static let textColor = Color(hex: 0x333333)!
    static let subTextColor = Color(hex: 0x666666)!
    static let themeWhite = Color(red: 0.95, green: 0.95, blue: 0.95)
}
...
extension Color {
    ...
    init?(hexString: String, transparency: CGFloat = 1) {
        var string = ""
